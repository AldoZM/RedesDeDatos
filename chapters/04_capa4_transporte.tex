...
\begin{tikzpicture}[
    ...
    nota/.style={font=\small\ttfamily}
]
\node[font=\bfseries] (client) at (0,  0) {Cliente};
\node[font=\bfseries] (server) at (8,  0) {Servidor};
\draw[thick] (0,-0.3) -- (0,-5.5);
\draw[thick] (8,-0.3) -- (8,-5.5);

% SYN
\draw[msg, blue] (0,-1.0) -- (8,-1.8)
    node[midway, above, sloped, font=\small] {\textbf{SYN} seq=1000};
\node[nota, left] at (0,-1.0) {CLOSED};
\node[nota, right] at (8,-1.8) {SYN\_RCVD};

% SYN-ACK
\draw[msg, orange] (8,-1.8) -- (0,-2.8)
    node[midway, above, sloped, font=\small] {\textbf{SYN+ACK} seq=5000, ack=1001};
\node[nota, left] at (0,-2.8) {SYN\_SENT};

% ACK
\draw[msg, green!60!black] (0,-2.8) -- (8,-3.6)
...
\node[font=\small\itshape, text=green!60!black] at (4,-4.4)
